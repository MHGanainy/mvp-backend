...
export const createBlogArticleSchema = z.object({
  ...
  featuredImageUrl: z.string().url().optional().default('https://placehold.co/1200x630/1a365d/ffffff?text=SimsBuddy+Blog'),
  featuredImageAlt: z.string().trim().optional().default('SimsBuddy Blog article'),
